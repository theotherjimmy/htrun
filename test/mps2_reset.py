...
from mbed_host_tests.plugins.reset_mps2 import HostTestPluginResetMethod_MPS2
...
class MPS2ResetTestCase(unittest.TestCase):
    ...
    @mock.patch("mbed_host_tests.plugins.reset_mps2.HostTestPluginResetMethod_MPS2.run_command")
